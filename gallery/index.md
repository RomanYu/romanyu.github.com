...
See [My Love]({{ site.url }}/gallery/mylove) for details.

## Xiling Snow Mountain 「西岭雪山」

**Oct, 5, 2015**

> Xiling Snow Mountain is located in Dayi County, about 95 kilometers (59 miles) away from the Chengdu urban area. Covering an area of 375 square kilometers (145 square miles), it is one of the world natural heritages, a habitat for giant pandas, a great site for skiing, and a national key scenic spot. The mountain is covered with snow all year round and is 5,346 meters (17,539 feet) above sea-level and is the highest peak in Chengdu area.
...
Click [Xiling Snow Mountain]({{ site.url }}/gallery/xiling) to see more pictures.
